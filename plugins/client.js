...
import Amazonses from './packages/amazonses/lib/manifest.json';
import Appwrite from './packages/appwrite/lib/manifest.json';
import Athena from './packages/athena/lib/manifest.json';
import Baserow from './packages/baserow/lib/manifest.json';
import Bigquery from './packages/bigquery/lib/manifest.json';
import Clickhouse from './packages/clickhouse/lib/manifest.json';
import Cosmosdb from './packages/cosmosdb/lib/manifest.json';
...
import Notion from './packages/notion/lib/manifest.json';
import Openapi from './packages/openapi/lib/manifest.json';
...
import Platmaapi from './packages/platmaapi/lib/manifest.json';
import Rethinkdb from './packages/rethinkdb/lib/manifest.json';
...
import Woocommerce from './packages/woocommerce/lib/manifest.json';
import Zendesk from './packages/zendesk/lib/manifest.json';

import AirtableOperation from './packages/airtable/lib/operations.json';
import AmazonsesOperation from './packages/amazonses/lib/operations.json';
import AppwriteOperation from './packages/appwrite/lib/operations.json';
import AthenaOperation from './packages/athena/lib/operations.json';
import BaserowOperation from './packages/baserow/lib/operations.json';
import BigqueryOperation from './packages/bigquery/lib/operations.json';
import ClickhouseOperation from './packages/clickhouse/lib/operations.json';
import CosmosdbOperation from './packages/cosmosdb/lib/operations.json';
...
import GrpcOperation from './packages/grpc/lib/operations.json';
...
import MariadbOperation from './packages/mariadb/lib/operations.json';
...
import NotionOperation from './packages/notion/lib/operations.json';
import OpenapiOperation from './packages/openapi/lib/operations.json';
...
import PlatmaapiOperation from './packages/platmaapi/lib/operations.json';
import RethinkdbOperation from './packages/rethinkdb/lib/operations.json';
...
import WoocommerceOperation from './packages/woocommerce/lib/operations.json';
import ZendeskOperation from './packages/zendesk/lib/operations.json';

import airtableSvg from './packages/airtable/lib/icon.svg';
import amazonsesSvg from './packages/amazonses/lib/icon.svg';
import appwriteSvg from './packages/appwrite/lib/icon.svg';
import athenaSvg from './packages/athena/lib/icon.svg';
import baserowSvg from './packages/baserow/lib/icon.svg';
import bigquerySvg from './packages/bigquery/lib/icon.svg';
import clickhouseSvg from './packages/clickhouse/lib/icon.svg';
import cosmosdbSvg from './packages/cosmosdb/lib/icon.svg';
...
import notionSvg from './packages/notion/lib/icon.svg';
import openapiSvg from './packages/openapi/lib/icon.svg';
...
import platmaapiSvg from './packages/platmaapi/lib/icon.svg';
import rethinkdbSvg from './packages/rethinkdb/lib/icon.svg';
...
import woocommerceSvg from './packages/woocommerce/lib/icon.svg';
import zendeskSvg from './packages/zendesk/lib/icon.svg';
...
export const allOperations = {
  ...
  Amazonses: AmazonsesOperation,
  Appwrite: AppwriteOperation,
  Athena: AthenaOperation,
  Baserow: BaserowOperation,
  Bigquery: BigqueryOperation,
  Clickhouse: ClickhouseOperation,
  Cosmosdb: CosmosdbOperation,
  ...
  Platmaapi: PlatmaapiOperation,
  Rethinkdb: RethinkdbOperation,
  S3: S3Operation,
  ...
  Woocommerce: WoocommerceOperation,
  Zendesk: ZendeskOperation,
};

export const allSvgs = {
  airtable: airtableSvg,
  amazonses: amazonsesSvg,
  appwrite: appwriteSvg,
  athena: athenaSvg,
  baserow: baserowSvg,
  bigquery: bigquerySvg,
  clickhouse: clickhouseSvg,
  cosmosdb: cosmosdbSvg,
  couchdb: couchdbSvg,
  ...
  redis: redisSvg,
  restapi: restapiSvg,
  platmaapi: platmaapiSvg,
  rethinkdb: rethinkdbSvg,
  s3: s3Svg,
