...
export const loadPyodide = async () => {
  try {
    ...
    console.error('loadPyodide error', error);
  }
};
...
export const validateByRegExp = (value, regexp, errorMessage) => {
  const isMatch = regexp.test(value);
  if (isMatch) return [value, null];
  else return [value, errorMessage ?? 'Invalid value'];
};
