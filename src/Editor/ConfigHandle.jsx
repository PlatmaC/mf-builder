...
import BugIcon from '@assets/images/icons/editor/left-sidebar/debugger.svg';

import '@/_styles/editor/config-handle.scss';
...
export const ConfigHandle = function ConfigHandle({
  ...
  const hasInvalidProperty = Object.values(component?.definition?.properties).some(
    ({ isInvalid, isActive }) => isInvalid && isActive
  );
      ...
      >
        ...
        >
          <img
            ...
            draggable="false"
          />
          {hasInvalidProperty && <BugIcon className="config-handle__bug-icon" />}
