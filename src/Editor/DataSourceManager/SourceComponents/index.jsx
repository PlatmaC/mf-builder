...
import { allManifests } from '@plugins/client';
import { PLATMA_SUPPORT_DATASOURCE } from '../constants';

PLATMA_SUPPORT_DATASOURCE;

// Googlesheets Baserow
export const PlatmaSupportedSources = Object.keys(allManifests).reduce((accumulator, currentValue) => {
  if (PLATMA_SUPPORT_DATASOURCE.includes(currentValue)) accumulator.push(allManifests[currentValue].source);
  return accumulator;
}, []);
