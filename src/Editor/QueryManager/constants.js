export const staticDataSources = [
  { kind: 'tooljetdb', id: 'null', name: 'InBuild DB' },
  { kind: 'restapi', id: 'null', name: 'REST API' },
  { kind: 'platmaapi', id: 'null', name: 'Platma API' },
...
export const defaultSources = {
  platmaapi: { kind: 'platmaapi', id: 'null', name: 'REST API' },
  restapi: { kind: 'restapi', id: 'null', name: 'REST API' },
  runjs: { kind: 'runjs', id: 'runjs', name: 'Run JavaScript code' },
  tooljetdb: { kind: 'tooljetdb', id: 'null', name: 'InBuild DB' },
